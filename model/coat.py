...
def _cfg_coat(url='', **kwargs):
    return {
        'url': url,
        'num_classes': 1, 'input_size': (3, 352, 352), 'pool_size': None,
...
class SerialBlock(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
        ...
        self.mlp = coat_Mlp(in_features=dim, hidden_features=mlp_hidden_dim, act_layer=act_layer, drop=drop)
...
class ParallelBlock(nn.Module):
    ...
    def __init__(self, dims, num_heads, mlp_ratios=[], qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
        ...
        self.mlp2 = self.mlp3 = self.mlp4 = coat_Mlp(in_features=dims[1], hidden_features=mlp_hidden_dim, act_layer=act_layer, drop=drop)
